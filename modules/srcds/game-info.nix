rec {
  gameIds = {
    "740" = { game = "Counter-Strike: Global Offensive"; folder = "csgo"; windowsWorkaround = false; sourceTV = true; };
    "232330" = { game = "Counter-Strike: Source"; folder = "cstrike"; windowsWorkaround = false; sourceTV = true; };
    "232290" = { game = "Day of Defeat: Source"; folder = "dod"; windowsWorkaround = false; sourceTV = true; };
    "4020" = { game = "Garry's Mod"; folder = "garrysmod"; windowsWorkaround = false; sourceTV = true; };
    "232370" = { game = "Half-Life 2: Deathmatch"; folder = "hl2mp"; windowsWorkaround = false; sourceTV = false; };
    "255470" = { game = "Half-Life Deathmatch: Source"; folder = "hl1mp"; windowsWorkaround = true; sourceTV = false; };
